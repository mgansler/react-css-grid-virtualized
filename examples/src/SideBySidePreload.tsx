...
export const SideBySidePreload: React.FC = () => {
  return <div className={"sidebyside"}>
    <div className={"column left"}>
      ...
      <Grid Item={Kitten} items={items} gridGap={10} padding={5} minItemHeight={200} minItemWidth={200} preload={0}/>
    </div>
    <div className={"column right"}>
      <span className={"Header"}>2 Rows Preload</span>
      <Grid Item={Kitten} items={items} gridGap={10} padding={5} minItemHeight={200} minItemWidth={200} preload={2}/>
    </div>
  </div>
}
